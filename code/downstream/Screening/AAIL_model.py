...
class ContrastiveOutput(ModelOutput):
    ...
    logit_pos: torch.FloatTensor = None
    logit_neg: torch.FloatTensor = None
...
class AntigenAntibodyModel(nn.Module): ## 这里二分类修改成了feature_dim,2 本来是feature_dim,1 后面接nn.tanh()做-1到1之间的预测并算对比学习的
